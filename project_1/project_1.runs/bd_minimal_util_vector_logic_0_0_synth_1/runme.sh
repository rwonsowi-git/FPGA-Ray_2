...
HD_PWD='C:/Users/Randy/Desktop/repos/FPGA-Ray_2/project_1/project_1.runs/bd_minimal_util_vector_logic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_minimal_util_vector_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_minimal_util_vector_logic_0_0.tcl
