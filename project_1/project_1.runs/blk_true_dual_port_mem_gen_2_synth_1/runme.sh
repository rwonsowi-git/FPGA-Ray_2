...
HD_PWD='C:/Users/Randy/Desktop/repos/FPGA-Ray_2/project_1/project_1.runs/blk_true_dual_port_mem_gen_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_true_dual_port_mem_gen_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_true_dual_port_mem_gen_2.tcl
