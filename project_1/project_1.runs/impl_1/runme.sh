...
HD_PWD='C:/Users/Randy/Desktop/repos/FPGA-Ray_2/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_minimal_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bd_minimal_wrapper.tcl -notrace
