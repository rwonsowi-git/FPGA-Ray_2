...
#
# Generated by export_simulation on Sat Mar 21 16:08:54 -0700 2026
#
################################################################################
...
'-reset_run' switch to the './bd_minimal.sh' script.

./bd_minimal.sh -reset_run
...
./bd_minimal.sh -noclean_files

For more information on the script, please type './bd_minimal.sh -help'.
