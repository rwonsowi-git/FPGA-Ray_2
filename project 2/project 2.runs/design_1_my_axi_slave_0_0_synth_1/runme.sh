...
HD_PWD='C:/Users/Randy/Desktop/repos/FPGA-Ray_2/project 2/project 2.runs/design_1_my_axi_slave_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_my_axi_slave_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_my_axi_slave_0_0.tcl
